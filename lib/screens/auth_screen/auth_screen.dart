                                ...
                                child: Ink(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: (){
                                      ...
                                      bool validated=formKey.currentState!.validate();if (validated) {
                                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("SUCCESS")));
                                        StorageRepository.setString(key: "full_name", value: nameController.text.toString(),);
                                        StorageRepository.setString(key: "email", value: emailController.text.toString(),);
                                        StorageRepository.setString(key: "password", value: passwordController.text.toString(),);
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              215.getH(),
                              UniversalTextInput(controller: emailLoginController, hintText: "Email", type: TextInputType.emailAddress, regExp:  AppConstants.emailRegExp, errorTitle: "Email", title: "Email"),
                              24.getH(),
                              UniversalTextInput(controller: passwordLoginController, hintText: "Password", type: TextInputType.visiblePassword, regExp:  AppConstants.passwordRegExp, errorTitle: "Password", title: "Password"),
                              32.getH(),
                              Material(
                                color: AppColors.transparent,
                                child: Ink(
                                  ...
                                  child: InkWell(
                                    borderRadius: BorderRadius.circular(4),
                                    onTap: (){
                                      print(emailLoginController.text.toString());
                                      print(StorageRepository.getString(key: "email"));
                                     if ( emailLoginController.text.toString()==StorageRepository.getString(key: "email") && passwordLoginController.text.toString()==StorageRepository.getString(key: "password") ) {
                              ...
                              TextButton(onPressed: (){
                                ...
                                pageController.animateToPage(1, duration: Duration(milliseconds: 300), curve: Curves.ease); // PageViewni Create an account sahifasiga o'tkazish
                              }, child: Text("Don’t have an account? Sign-up", style: AppTextStyle.rubikRegular.copyWith(fontSize: 18.w(), color: AppColors.c_FBDF00),))
                            ],
                          ),
                        ),
